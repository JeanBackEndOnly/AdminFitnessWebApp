...
<body>
    <div class="header">
        ...
        <div class="search-form">
            ...
            <a href="add_Members/register.php"><button class="add-button"><img src="../../image/adding-icon.png"></button></a>
        </div>
        <div class="table-div">
        ...
        <div class="side-nav">
            ...
            <div class="navs-div">
                <ul>
                    <a href="../admin_dashboard/dashboard.php"><li id="dashboard-li"><img src="../../image/dashboard_icon.png" class="dashboard_icon-img"><p>DASHBOARD</p></li></a>
                    <a href=""><li id="members-li"><img src="../../image/membership-icon.png" class="members-img"><p>MEMBERSHIP</p></li></a>
