    ...
    <div class="outer-container">
        <div class="inner-container">
            ...
            <div class="back-button">
                <a href="search.php"><img src="../../../image/button-back.png" class="back-button"></a>
            </div>
            <form action="edit_func.php?member_id=<?php echo $result['member_id'] ?> " method="post">       
                <div class="form-columns">
                    ...
                    <div class="column-one">
                        ...
                        <input type="text" name="gender" value="<?php echo $result["gender"]; ?>" placeholder="Gender">
